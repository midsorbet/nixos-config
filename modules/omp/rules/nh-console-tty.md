...
TTY. If the session has no interactive UI, stop and explain that prerequisite.
Never silently fall back or create a terminal window. Keep the repository's
build-before-switch, host order, and explicit deployment-approval boundaries.
