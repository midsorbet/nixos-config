-- Vendored from nvim-mini/MiniMax configs/nvim-0.12 at
-- revision 73420d884a6117e77e6d1df4d6ca7144c8444814 (2026-08-15).
-- Local changes are committed directly in this repository.
...
-- ├── 90_nix.lua      Nix-managed themes and language servers
...
-- 'mini.nvim' is loaded from the Nix wrapper and powers most MiniMax features.
-- See 'plugin/30_mini.lua' for how it is used. It is available now so
-- 'mini.misc' can provide the loading helpers below.
